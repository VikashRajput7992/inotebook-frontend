...
function Notes(props) {
    ...
    const { notes, getAllNotes, editNote,mode } = context;
        ...
        <>
            ...
            <div className="modal fade" id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className={`modal-content ${mode==='dark'?'bg-dark':''}`}>
                        ...
                        <div className="modal-body">
                            <form className='my-3'>
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" id="etitle" name="etitle" value={note.etitle} onChange={handleOnChange} aria-describedby="emailHelp" />
                                </div>
                                <div className="mb-3">
